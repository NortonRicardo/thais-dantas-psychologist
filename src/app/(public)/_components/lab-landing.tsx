  ...
  return (
    <div className="text-[#2D2D2D]">
      ...
      <div className="bg-white">
        ...
        {/* ── REVIEWS ──────────────────────────────────────────────────────── */}
        <section className="border-t border-[#556040]/30 px-6 py-14 sm:px-10">
          <div className="mx-auto max-w-5xl">
              ...
              {[
                {
                  name: 'Ana Carolina S.',
                  time: 'há 2 semanas',
                  text: 'A Thais é uma profissional incrível. Me sinto acolhida em cada sessão e tenho percebido mudanças reais no meu comportamento alimentar.',
                },
                {
                  name: 'Mariana P.',
                  time: 'há 1 mês',
                  text: 'Passei pela cirurgia bariátrica e o suporte da Thais foi fundamental. Ela entende as questões emocionais por trás do processo de uma forma que poucos conseguem.',
                },
                {
                  name: 'Fernanda R.',
                  time: 'há 2 meses',
                  text: 'Comecei a terapia por conta da endometriose e o quanto isso afetava minha saúde mental. Com a Thais encontrei um espaço seguro e sem julgamentos.',
                },
                {
                  name: 'Juliana M.',
                  time: 'há 3 meses',
                  text: 'A abordagem da TCC com a Thais mudou a forma como encaro a alimentação. Finalmente entendi o que me levava ao comer emocional.',
                },
              ].map(({ name, time, text }) => (
                <div
                  key={name}
                  className="flex flex-col gap-4 rounded-sm border border-[#556040]/12 p-5 transition-colors hover:border-[#556040]/25"
                >
                  <div className="flex items-center gap-3">
                    <div className="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#556040]/10 text-[11px] font-semibold text-[#556040]">
                      {name.charAt(0)}
                    </div>
                    <div>
