...
const NAV_ITEMS = [
  { href: '/manager/infraestrutura/hardware', label: 'Hardware' },
  { href: '/manager/infraestrutura/plataformas', label: 'Plataformas' },
  { href: '/manager/infraestrutura/parcerias', label: 'Parcerias' },
] as const
    ...
    <div className="mx-auto max-w-[1400px] px-6">
      <div className="flex min-h-[calc(100vh-3.5rem)] gap-0 pb-8">
        <aside className="mt-8 w-52 shrink-0 self-stretch rounded-xl bg-white/[0.08] p-3 pt-8">
          ...
          <nav aria-label="Infraestrutura" className="flex flex-col gap-0.5">
            {NAV_ITEMS.map(item => {
              const isCurrent =
