          ...
          <TableBody>
            ...
            {!loading && paged.map(row => (
              <TableRow key={row.id} className="border-white/[0.07] transition-colors hover:bg-white/[0.04]">
                ...
                <TableCell>
                  <Badge className={`border text-[0.65rem] uppercase tracking-wide ${TYPE_COLORS[row.type] ?? 'bg-white/10 text-white/60 border-white/20'}`}>
                    {row.type}
                  </Badge>
                </TableCell>
                ...
                <TableCell className="text-sm text-white/60 text-center">
                  {(() => {
                    ...
                    return <><span className="block">{date}</span><span className="block text-white/35 text-xs">{time}</span></>
                  })()}
                </TableCell>
                ...
                <TableCell className="text-center">
                  {row.featured
                    ? <span className="text-[#00d4ff] text-xs font-semibold">✦ Sim</span>
                  ...
                  <div className="flex items-center justify-end gap-1">
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button variant="ghost" size="icon" className="h-8 w-8 text-white/50 hover:text-rose-400 hover:bg-rose-400/10">
                          <Trash2 size={14} />
                        </Button>
                      </AlertDialogTrigger>
