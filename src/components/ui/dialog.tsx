...
/** For Combobox etc.: render portaled content inside the dialog so mouse works in modal. */
...
export function useDialogContentRef() {
  return React.useContext(DialogContentRefContext)
}
