...
function ComboboxContent({
  ...
  > & {
    /** Render inside this element (e.g. dialog). If omitted, uses dialog context when inside DialogContent. */
    container?: React.RefObject<HTMLElement | null> | HTMLElement | null
  }) {
  const dialogContentRef = useDialogContentRef()
  const container = containerProp ?? dialogContentRef ?? undefined
  return (
